...
{
    public class LogListarServicios
    {
        public ResListarServicios listarServicios()
        {
            ResListarServicios res = new ResListarServicios();
            res.resultado = false;
            ...
            try
            {
                ...
                List<SP_ListarServiciosResult> resultado;

                using (LinQDataContext db = new LinQDataContext())
                {
                    resultado = db.SP_ListarServicios(
                        ref idReturn,
                        ref errorID,
        ...
        private List<Servicio> factoriaListaServicios(List<SP_ListarServiciosResult> lista)
        {
            ...
            foreach (var item in lista)
            {
                ...
                if (item.SUB_CATEGORIA_ID.HasValue)
                {
                    ...
                    if (!serviciosDict[item.SERVICIO_ID].SubCategorias
                        .Any(s => s.SubCategoriaId == sub.SubCategoriaId))
                    {
