...
{
    public class LogListarServiciosPorSubCategoriaId
    {
        public ResListarServiciosPorSubCategoriaId listarServicios(ReqListarServiciosPorSubCategoriaId req)
        {
            ResListarServiciosPorSubCategoriaId res = new ResListarServiciosPorSubCategoriaId();
            ...
            try
            {
                ...
                if (req.SubCategoria.SubCategoriaId <= 0)
                {
                    res.resultado = false;
                    res.error.Add(new Error
                    {
                        ErrorCode = (int)enumErrores.idFaltante,
                        Message = "SubCategoria ID inválido"
                    });
                    return res;
                }
                ...
                List<SP_ListarServiciosPorSubCategoriaIdResult> resultado;

                using (LinQDataContext db = new LinQDataContext())
                {
                    resultado = db.SP_ListarServiciosPorSubCategoriaId(
                        req.SubCategoria.SubCategoriaId,
                        ref idReturn,
                        ref errorID,
        ...
        private List<Servicio> factoriaListaServicios(List<SP_ListarServiciosPorSubCategoriaIdResult> lista)
        {
